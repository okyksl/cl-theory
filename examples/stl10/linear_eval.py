...
def parse_option():
    ...
    parser.add_argument(
        "encoder_checkpoint", type=str, help="Encoder checkpoint to evaluate"
    )
    parser.add_argument(
        "--feat_dim", type=int, default=128, help="Encoder feature dimensionality"
    )
    ...
    parser.add_argument(
        "--lr_decay_rate", type=float, default=0.2, help="Learning rate decay rate"
    )
    parser.add_argument(
        "--lr_decay_epochs",
        type=str,
